...
> **⚠️ Note**: The Learning to Fly (L2F) simulator has been upstreamed into RLtools and is maintained and evolved in (rl_tools/rl/environments/l2f)[https://github.com/rl-tools/rl-tools/tree/master/include/rl_tools/rl/environments/l2f]
...
> **Note:** This is a note.
> It can span multiple lines and will appear as a block.
